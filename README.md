...
Web 软件支持手机与电脑、自适应布局、全文搜索、标签筛选、今日专题、30 天历史和 PWA 安装。每天自动轮换“全球治理、中国、美国、经济金融、军事安全、科技能源、气候公共安全”七个专题。英文新闻采用双栏排版：电脑端左英文、右中文，手机端英文在上、中文在下。
...
- `public/data/archive.json` 保存网站最近 30 天的公开新闻数据，供历史搜索使用，不包含任何邮箱或密钥。
